##################################################################################################################
#####merge Normal.celltype and TypeII.celltype---merge Normal.celltype and TypeII.celltype######################################
#####merge Normal.celltype and TypeII.celltype---merge Normal.celltype and TypeII.celltype######################################
#####merge Normal.celltype and TypeII.celltype---merge Normal.celltype and TypeII.celltype######################################
...
Normal.celltype
TypeII.celltype <- readRDS("TypeII_cellchat.celltype_after_cellchat.rds")
TypeII.celltype

levels(Normal.celltype@idents)
levels(TypeII.celltype@idents)
...
#group.new = levels(TypeII.celltype@idents)
...
#object.list <- list(Nomal = Normal.celltype, TypeII = TypeII.celltype)
...
TypeII.celltype <- liftCellChat(TypeII.celltype , group.new = levels( cellchat@idents$joint) )
levels(Normal.celltype@idents)
levels(TypeII.celltype@idents)
