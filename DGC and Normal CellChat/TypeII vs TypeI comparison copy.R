##################################################################################################################
#####merge TypeII.leiden_1 and TypeI.leiden_1---merge TypeII.leiden_1 and TypeI.leiden_1######################################
#####merge TypeII.leiden_1 and TypeI.leiden_1---merge TypeII.leiden_1 and TypeI.leiden_1######################################
#####merge TypeII.leiden_1 and TypeI.leiden_1---merge TypeII.leiden_1 and TypeI.leiden_1######################################
...
#group.new = levels(TypeI.leiden_1@idents)
#TypeII.leiden_1 <- liftCellChat(TypeII.leiden_1, group.new)
#levels(TypeII.leiden_1@idents)
...
#object.list <- list(Nomal = TypeII.leiden_1, TypeI = TypeI.leiden_1)
#cellchat <- mergeCellChat(object.list, add.names = names(object.list), cell.prefix = TRUE)

# Define the cell labels to lift up, if the idents are overlaped, but can't cover each other
object.list <- list(TypeII = TypeII.leiden_1, TypeI = TypeI.leiden_1)
cellchat <- mergeCellChat(object.list, add.names = names(object.list), cell.prefix = TRUE)
...
net.down <- subsetCommunication(cellchat, net = net, datasets = "TypeII",ligand.logFC = -0.1, receptor.logFC = -0.1)
